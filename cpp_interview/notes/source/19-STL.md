...
![image-20220605232452303.png](https://cdn.nlark.com/yuque/0/2022/png/916648/1654702622512-7606cabf-7afe-4d52-b18f-c98982639e25.png#clientId=u99e777d5-9d0d-4&crop=0&crop=0&crop=1&crop=1&from=drop&id=u1aa14415&name=image-20220605232452303.png&originHeight=574&originWidth=754&originalType=binary&ratio=1&rotation=0&showTitle=false&size=60954&status=done&style=none&taskId=ud6cb50c9-f06a-4779-badd-d7f6b0372d4&title=)
...
![image-20220605232534904.png](https://cdn.nlark.com/yuque/0/2022/png/916648/1654702612745-d85d9e82-8d81-4f5d-830d-df1c3e3fcf85.png#clientId=u99e777d5-9d0d-4&crop=0&crop=0&crop=1&crop=1&from=drop&id=ud18a6dc8&name=image-20220605232534904.png&originHeight=399&originWidth=758&originalType=binary&ratio=1&rotation=0&showTitle=false&size=53997&status=done&style=none&taskId=u5ee1627d-9382-4ca4-8c8f-bc960aba172&title=)
...
bind是可以改变函数的形态的（改变函数的类型）,函数的类型包括<br />函数的返回类型，以及函数的参数列表（参数的个数，参数的顺序，参数类型）
